...
# Latest version of azure-ai-agents can give import error for McpTool,
# to handle this issue first uninstall pip uninstall azure-ai-agents
# then do pip install --pre --upgrade azure-ai-agents
